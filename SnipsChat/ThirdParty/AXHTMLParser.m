...
-(instancetype) initWithEncoding:(xmlCharEncoding) encoding
{
    ...
    if (self) {
        ...
        _context = htmlCreatePushParserCtxt(&_saxHandler, (__bridge void*)self, NULL, 0, NULL, encoding);
...
- (void) parse:(NSData *)data
{
    ...
    htmlParseChunk(_context, [data bytes], (int)[data length], 0);
    
    if(data == nil)
        htmlParseChunk(_context, nil, 0, 1);
